...
class UpcomingEventsMapperTest {

    @Test
    fun shouldReturnUpcomingEventsList() {
        val upcomingEventDTO =
        ...
        val eventsList = listOf(upcomingEventDTO, upcomingEventDTO)

        val actual = eventsList.toUpcomingEventsList()
